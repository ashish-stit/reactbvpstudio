           ...
           <section className="tables">   
             <div className="container-fluid">
              <div className="tab-content">
                  ...
                  <div className="tab-pane container fade col-lg-12" id="menu1">
                    <div className="row">
                      <div className="col-lg-3">
                        <div className="card">
                          <div className="card-body">
                  ...
                  <div className="tab-pane container fade col-lg-12" id="menu2">
                    <div className="row">
                      <div className="col-lg-3">
                        <div className="card">
                          <div className="card-body">
                  ...
                  <div className="tab-pane container fade col-lg-12" id="menu3">
                    <div className="row">
                      <div className="col-lg-3">
                        <div className="card">
                          <div className="card-body">
                  ...
                  <div className="tab-pane container fade col-lg-12" id="menu4">
                    <div className="row">
                      <div className="col-lg-3">
                        <div className="card">
                          <div className="card-body">
